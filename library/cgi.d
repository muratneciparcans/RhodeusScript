...
public:
	...
	this(long maxContentLength = 0,//5_000_000
	...
	*/
	...
	void setCookie(string name, string data, long expiresIn = 0, string path = "", string domain = "", bool httpOnly = false, bool secure = false) {
		assert(!outputtedResponseData);
		string cookie = name ~ "=";
		cookie ~= data;
		if(path !is "")
